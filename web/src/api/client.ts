import type {
  ...
  CreateUserInput,
  CreateUserResponse,
  DeleteCompanionPairingResponse,
  Edge,
  EdgeAuditEntry,
  JobsQueryParams,
  LineageResponse,
...
export const api = {
  ...
  trashAsset: (id: number, body: { keepExports: boolean }) =>
    request<{ ok: boolean }>(`/api/v1/assets/${id}/trash`, { method: "POST", body: JSON.stringify(body) }),
